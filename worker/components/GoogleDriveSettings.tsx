  ...
  return <section className="drive-settings-module">
    ...
    <div className="drive-settings-layout">
      <form key={settings.updated_at} className="drive-credentials-card" onSubmit={save}>
        ...
        <button className="primary drive-save-button" disabled={Boolean(busy)}>{busy === "save" ? "Salvando…" : "Salvar configurações"}</button>
      </form>
    ...
    <div className="drive-security-note"><b>Segurança</b><span>O e-mail, Client ID e Client Secret podem ser trocados pelo administrador. Tokens e segredos ficam em tabelas sem acesso pelo navegador e são cifrados antes de serem gravados.</span></div>
  </section>;
}
