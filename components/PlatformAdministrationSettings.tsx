  ...
  return <section className="platform-admin-module">
    ...
    <div className="platform-two-column">
      <form key={`platform-automation-${settings.updated_at}`} className="platform-card" onSubmit={saveAutomation}>
        ...
        <div className="platform-actions">
          ...
          <button type="submit" className="primary" disabled={Boolean(busy)}>{busy === "save-automation" ? "Salvando…" : "Salvar automação"}</button>
        </div>
      </form>
    ...
    <div className="platform-sql-layout">
      <form className="platform-card platform-sql-card" onSubmit={executeSql}>
        ...
        <div className="platform-actions"><button type="submit" className="danger" disabled={Boolean(busy) || !sqlFile}>{busy === "execute-sql" ? "Executando…" : "Executar SQL no Supabase"}</button></div>
      </form>
